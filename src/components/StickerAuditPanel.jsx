...
import { flattenStickerAuditRows } from '../utils/stickerAuditRows.js'
...
export function StickerAuditPanel() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setRows(flattenStickerAuditRows(list))
    } catch (e) {
      setRows([])
  ...
  return (
    <div className="pad">
      <p className="muted small" style={{ marginBottom: '1rem' }}>
        Historial de impresiones de stickers. Una fila por pieza impresa, ordenado por orden, parte y pieza.
      </p>
