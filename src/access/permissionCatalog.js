...
export const ENDPOINT_CATALOG = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      ['GET', '/api/transport/guias'],
      ['GET', '/api/transport/guias/{id}'],
      ['POST', '/api/transport/guias'],
      ['PUT', '/api/transport/guias/{id}'],
      ['POST', '/api/transport/guias/{id}/pales'],
      ['DELETE', '/api/transport/guias/{id}/pales/{guiaPaleId}'],
