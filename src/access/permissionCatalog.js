...
export const ENDPOINT_CATALOG = [
  {
    ...
    endpoints: [
      ...
      ['DELETE', '/api/biesse/scan/orders/{orderId}'],
      ...
      ['GET', '/api/biesse/scan/trazabilidad'],
  ...
  },
  {
    ...
    endpoints: [
      ...
      ['GET', '/api/biesse/monitor/boards/history'],
      ['GET', '/api/biesse/monitor/boards/summary'],
  ...
  },
  {
    ...
    endpoints: [
      ...
      ['POST', '/api/admin/backup/run/files'],
      ...
      ['POST', '/api/admin/backup/restore/files'],
      ['POST', '/api/admin/backup/restore/files/upload'],
