    ...
    <div className="page">
      <header className="page__head">
        ...
        <p className="page__lead">
          Flota de vehículos y auditoría de cambios. Las <strong>guías de despacho</strong> (número correlativo,
          líneas y palés escaneados) se gestionan en <strong>Inventario → Guías de despacho</strong>.
        </p>
      </header>
      ...
      {tab === 'vehiculos' ? (
        ...
        <div className="card card--table pad" style={{ marginTop: '1rem' }}>
          ...
          <p className="muted small form-hint">
            Filtra por tipo de entidad, ID concreto o correlation ID. El actor se toma del empleado en sesión.
          </p>
          <form
          ...
          >
            ...
            <label className="field" style={{ gridColumn: '1 / -1' }}>
              ...
              <input
                ...
                placeholder="ID de correlación (p. ej. guía legacy)"
              />
            </label>
